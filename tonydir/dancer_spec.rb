...
describe Dancer do
  ...
  it "delete extra dancer" do
    dancer.queue_dance_with("Mikhail Baryshnikov")
    dancer.queue_dance_with("Anna")
    dancer.queue_dance_with("Pavlova")
    dancer.queue_dance_with("Mi l Baryshnikov")
    dancer.queue_dance_with("Annnnnna")
    dancer.queue_dance_with("llllllll")
    expect(dancer.limit_reached).to eq ["Mikhail Baryshnikov", "Anna", "Pavlova"]
